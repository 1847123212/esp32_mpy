...
#define CONFIG_IDF_TARGET_ESP32S3_BETA_VERSION_3 1
#define CONFIG_IDF_FIRMWARE_CHIP_ID 0x0006
...
#define CONFIG_SDCARD_MOSI_PIN 4
#define CONFIG_SDCARD_MISO_PIN 5
#define CONFIG_SDCARD_SCLK_PIN 6
#define CONFIG_SDCARD_CS_PIN 7
