...
#define HEAPMEM_SIZE    (0x400000)
#define  SPIRAM_START_ADDR     (0x3E000000-0x800000)
#define  OMV_HEAP_SIZE           (512*1024)
#define FB_BASE_ADDR    (SPIRAM_START_ADDR+OMV_HEAP_SIZE)		
#define JPEG_BUF_BASE_ADDR    (FB_BASE_ADDR+OMV_FB_SIZE)
#define FB_ALLOC_BASE_ADDR    (JPEG_BUF_BASE_ADDR+OMV_JPEG_BUF_SIZE)
